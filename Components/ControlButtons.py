...
class Buttons(Component.Component):
    ...
    def __init__(self,parent,state,config,rootWindow):
        ...
        button7.grid(row=0,column=6,columnspan=6,sticky='WE')
        button1.grid(row=1,column=0,columnspan=6,sticky='WE')
        button6.grid(row=1,column=6,columnspan=6,sticky='WE')
        button4.grid(row=2,column=0,columnspan=6,sticky='WE')
        button5.grid(row=2,column=6,columnspan=6,sticky='WE')
        button8.grid(row=3,column=0,columnspan=6,sticky='WE')
        button9.grid(row=3,column=6,columnspan=6,sticky='WE')
        button2.grid(row=4,column=0,columnspan=12,sticky='WE')
        self.buttons.extend([button1,button2,button3,button4,button5,button6,button7,button8,button9])
